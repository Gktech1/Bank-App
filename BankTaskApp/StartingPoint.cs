...
namespace BankTaskApp
    {
        ...
        CustomerServices customerCore = new CustomerServices();
        ...
        public void StartUI()
        {
            ...
            Console.WriteLine("\t\t\t********Welcome to Kunle Banking Console App*********");
            Console.WriteLine("\t\t------------------------------------------------------------");
            Console.ResetColor();
            string inputLine;
            do
        ...
        private void LoginInput()
        {
            ...
            var accountNumber = accountService.GetAccountNumberByName(name);
            if (check)
            {
        ...
        private void CreateAccount()
        {
            ...
            while (true)
            {
                ...
                Console.WriteLine("Please input right format like favourblessing1@gmail.com");
            }
            ...
            while (true)
            {
                ...
                Console.WriteLine("Please input right format like wisdom@12");
            }
        ...
        private void Dashboard(long initialAccountNumber, string name)
        {
            ...
            do
            {
                ...
                Console.WriteLine("Your Balance is {0}", accountService.GetBalance(initialAccountNumber));
        ...
        private void DepositMethod()
        {
            ...
            if (!accountService.CheckAccountNumberIfExists(accountNumber))
            {
            ...
            else
            {
                ...
                accountService.MakeDeposit("deposit", depositAmount, description, accountNumber);
            }
        }
        ...
        private void WithdrawMethod(long initialAccountNumber, string name)
        {
            ...
            string accountType = accountService.GetAccountType(name);
            ...
            else
            {
                ...
                description = Console.ReadLine();
                accountService.MakeWithdraw("Withdrawal", withdrawAmount, description, accountNumber);
            }
        }
        ...
        private void TransferMethod(long initialAccountNumber, string name)
        {
            ...
            decimal balance = accountService.GetBalance(debitAccountNumber);
            Console.WriteLine("Available Balance: {0}", balance);
            string accountType = accountService.GetAccountType(name);
            if (balance == 1000 && accountType == "Savings")
            {
            ...
            else
            {
                ...
                Console.WriteLine("Enter the reason for withdraw");
                description = Console.ReadLine();
                accountService.MakeTransfer("Transfer", transferAmount, description, debitAccountNumber, creditAccountNumber);
            }
        }
